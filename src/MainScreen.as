	...
	public class MainScreen extends BaseScreen
	{
		...
		public function MainScreen() 
		{
			...
			display(function (terminal:AsciiPanel):void {
				...
				terminal.write(" Ascii: " + String.fromCharCode(currentCharCode) + " (" + currentCharCode + ")", charGuiX, charGuiY - 2);
				for (var x:int = 0; x < 16; x++)
				for (var y:int = 0; y < 16; y++)
				{
					var char:int = x + y * 16;
					var bg = currentCharCode % 16 == x || Math.floor(currentCharCode / 16) == y ? 0xff666633 : 0xff101010;
